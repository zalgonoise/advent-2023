...
import (
	...
	"github.com/zalgonoise/advent-2023/cmd/aoc/day19"
	"github.com/zalgonoise/advent-2023/cmd/aoc/day21"
)
...
func run(logger *slog.Logger) (int, error) {
	...
	case 19:
		return day19.Exec(ctx, logger, os.Args[3:])

	case 21:
		return day21.Exec(ctx, logger, os.Args[3:])
	default:
