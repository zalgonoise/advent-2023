...
`,
			...
			wants: []CoordRange{
				...
				{XStart: 89, XEnd: 92, Y: 0},
				{XStart: 102, XEnd: 104, Y: 0},
				{XStart: 101, XEnd: 104, Y: 2},
				{XStart: 111, XEnd: 114, Y: 0},
				{XStart: 120, XEnd: 123, Y: 2},
				{XStart: 7, XEnd: 10, Y: 1},
				{XStart: 9, XEnd: 12, Y: 3},
				{XStart: 25, XEnd: 28, Y: 2},
				{XStart: 35, XEnd: 37, Y: 1},
				{XStart: 31, XEnd: 34, Y: 2},
				{XStart: 38, XEnd: 41, Y: 2},
				{XStart: 50, XEnd: 53, Y: 1},
				{XStart: 65, XEnd: 68, Y: 1},
				{XStart: 62, XEnd: 64, Y: 3},
				{XStart: 73, XEnd: 76, Y: 2},
				{XStart: 116, XEnd: 119, Y: 1},
				{XStart: 128, XEnd: 131, Y: 2},
				{XStart: 14, XEnd: 17, Y: 2},
				{XStart: 18, XEnd: 21, Y: 2},
				{XStart: 43, XEnd: 46, Y: 2},
				{XStart: 106, XEnd: 109, Y: 2},
			},
		},
	} {
		t.Run(testcase.name, func(t *testing.T) {
